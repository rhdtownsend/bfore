...
extlinks = {
    ...
    'repo': ('https://github.com/rhdtownsend/bfore/blob/{:s}/%s'.format(branch), None),
...
if version.endswith('+dev'):
    ...
    dist_dir = f'bfore-{version}'
    tarball = f'{dist_dir}.tar.gz'
    tarball_url = f'https://github.com/rhdtownsend/bfore/releases/download/v{version}/{tarball}'
