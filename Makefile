...
SRC_DIR = $(CURDIR)/src
SRC_DIRS = $(addprefix $(SRC_DIR)/,mesh common framebuffer view transform include)
...
.PHONY: all install clean install-forum clean-forum install-msg clean-msg
